        ...
        <div className=''>
            <div id='home' className='App-header lg:flex lg:flex-row w-full lg:justify-between items-start lg:items-center text-white' data-aos="fade-up" >
                <div data-aos="fade-right" className=" lg:px-40">
                    <h1 className="text-5xl text-center lg:text-left lg:text-9xl mb-10 mt-20 font-semibold">Anna <br></br> Lartey</h1>
                ...
                <div data-aos="fade-left" className="text-center font-bold text-6xl text-red-600 lg:mr-40 py-20 lg:py-0">
