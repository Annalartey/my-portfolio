...
function Contact() {
    return (
        <div id='contact' className='lg:flex lg:flex-row text-white py-40 App-header'>
               <div className=" lg:ml-40">
                    ...
                    <a href="../DetailedAbout" >
                        <button  data-aos="fade-up" className='border-2 font-bold text-xl lg:px-8 py-2  mt-10'> See More</button>
                    </a> 
               </div>
