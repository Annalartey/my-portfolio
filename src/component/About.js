           ...
           <div id='about' className='about  text-black pt-40 pb-40'>
               <div> 
                    <div data-aos="fade-left">
                        ...
                        <div className="w-40 lg:w-20 h-1 bg-red-600 ml-14 lg:ml-72 mb-10 rounded-2xl"></div>
                        <p className="text-center lg:text-left text-2xl mx-2 lg:mx-0 lg:pl-60">I am a student of AltSchool Africa, I am passionate about technology, <br></br> stories and anything art</p>
                    </div>
